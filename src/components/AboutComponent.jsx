  ...
  return (
    <section className="bg-black text-white py-20 px-6" id="about">
      <div className="container mx-auto text-center">
        {/* Section Title */}
        <h2 data-aos="fade-up" className="text-4xl md:text-5xl font-bold leading-tight mb-12 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-red-600">
          About Me
        </h2>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-evenly gap-12 mb-16">
          ...
          <div data-aos="fade-right" className="flex justify-center md:justify-start mb-8 md:mb-0">
            <div className="relative">
              <img src="/my_image.jpg" alt="Profile" className="rounded-full w-48 h-48 object-cover border-4 border-gradient-to-r from-purple-600 to-red-600 shadow-xl transition-transform transform hover:scale-105"/>
              {/* Hover Effect */}
          ...
          {/* Text Section */}
          <div data-aos="fade-left" className="flex flex-col justify-start md:max-w-3xl">
